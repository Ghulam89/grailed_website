      ...
      {links.map((link) => (
        <div>
          <div className="px-3 text-left md:cursor-pointer group">
            ...
            {link.submenu && (
              <div className="">
                <div className="absolute z-50 border   top-16 hidden group-hover:md:block hover:md:block">
                  <div className="">
                    {/* <div
                  ...
                  <div className="bg-white p-4   w-48 gap-10">
                    ...
                    {link.sublinks.map((mysublinks) => (
                      <div className=" flex justify-between  items-center" >
                        ...
                        <div className=" absolute z-50 border top-0 -right-44 p-4 bg-white w-44 hidden">
